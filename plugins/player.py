...
@Client.on_message(command(["/play", "توم" ,"play" ,"ش" ,"شغل" ,"تشغيل", f"/play@{BOT_USERNAME}", "تشغيل"]))
...
`تشغيل او شغل او توم + أسم المقطع الصوتي 🎧`
""",
            )
            return
        what = "Query Given"
        ...
        thumb ="https://telegra.ph//file/96898260711e18197be41.jpg"
